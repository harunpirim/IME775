...
def _(mo):
    ...
    **IME775: Data Driven Modeling and Optimization**
    ...
    📖 **Reference**: Watt, Borhani, & Katsaggelos (2020). *Machine Learning Refined* (2nd ed.), **Chapter 9**
...
def _():
    ...
    return Lasso, StandardScaler, np, plt
...
def _(mo):
    ...
    The L1 penalty encourages **sparsity** — many coefficients become exactly zero.
...
def _(Lasso, np, plt):
    ...
    for ax, alpha in zip(axes.flat, alphas):
        ...
        ax.set_title(f'α = {alpha}, Non-zero: {n_nonzero}')

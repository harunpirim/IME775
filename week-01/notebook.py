...
def _(mo):
    ...
    **IME775: Data Driven Modeling and Optimization**
    ...
    📖 **Reference**: Watt, Borhani, & Katsaggelos (2020). *Machine Learning Refined* (2nd ed.), **Chapter 1**
...
def _(mo):
    ...
    > enormous amounts of data and computing power." — *ML Refined, Ch. 1*
...
@app.cell
def _(intercept_slider, np, plt, slope_slider):

...
def _(mo):
    ...
    **IME775: Data Driven Modeling and Optimization**
    ...
    📖 **Reference**: Watt, Borhani, & Katsaggelos (2020). *Machine Learning Refined* (2nd ed.), **Chapter 4**
...
def _(np, plt):
    ...
    def newtons_method(grad_f, hess_f, w0, n_iter):
        path = [w0.copy()]
        w = w0.copy()
...
def _(mo):
    ...
    This is **quadratic convergence** — the number of correct digits roughly doubles each iteration!
